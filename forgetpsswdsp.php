...
//echo $mail;
$sql = "SELECT * FROM serviceprovider WHERE provideremailid='$mail'";
$result = mysqli_query($conn,$sql);
$count = mysqli_num_rows($result);
if($count==1)
{
  $userdata = mysqli_fetch_assoc($result);
  $uname = $userdata['providername'];
  $userid = $userdata['providerid'];
  $useremail = $userdata['provideremailid'];
  //echo $userid;
  //echo "<script>alert('hii')</script>";
...
document.location.href ="<?php echo "verifysp.php?userid=".$useremail; ?>";
</script> 
  <?php  
 }
 else
