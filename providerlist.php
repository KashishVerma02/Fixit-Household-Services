...
<body > 
  <nav class="navbar navbar-expand-lg navbar-light bg-light fixed-top">
   ...
   <!--   <form class="form-inline my-2 my-lg-0">
      <a class="nav-link" href="loginmain.php">LOGIN</a><a
...
<div class="container">
    ...
    <div class="col-sm">
      ...
      <div class="col-sm">
        <button class="button-51" role="button" onclick="maprecord()">City</button>
      </div> 
  </div>
  </div>
  ...
  <div class="d-flex justify-content-left row">
      ...
      <?php 
          ...
          <div class="row p-2 bg-white border rounded">
              ...
              <?php  $pid =  $row['providerid']; ?>
                  <h5>  <?php  echo $row['providername']; ?></h5> 
                  <div class="d-flex flex-row">
                      <div class="ratings mr-2"><i class="fa fa-star"></i><i class="fa fa-star"></i><i class="fa fa-star"></i><i class="fa fa-star"></i></div><span> <?php echo $row['ave rating'];
             ?> %</span>  
                  </div> 
...
<footer class="bg-light text-center relative-bottom">
    ...
    <script>function allrecord(){ window.location.href="<?php echo "providerlist.php?id=".$service;?>"; }
     ...
     function maprecord(){ window.location.href="<?php echo "promap.php?id=".$service;?>"; }
       </script>   
      </body>
</html>
<!-- HTML !-->
